...
public class ItemToolItem extends ItemTool {
    ...
    {
        ItemStack mat = ItemToolItem.getMaterial().getRepairItemStack();
        if (mat != null && net.minecraftforge.oredict.OreDictionary.itemMatches(mat, repair, false)) return true;
        return super.getIsRepairable(toRepair, repair);
    }


	public static float getAttackSpeedIn() {
		return attackSpeedIn;
	}


	public static void setAttackSpeedIn(float attackSpeedIn) {
		ItemToolItem.attackSpeedIn = attackSpeedIn;
	}


	public static Item.ToolMaterial getMaterial() {
		return material;
	}


	public static void setMaterial(Item.ToolMaterial material) {
		ItemToolItem.material = material;
	}
